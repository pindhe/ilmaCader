...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("  admin@familydatacenter.local / Admin@12345 (Super Admin)")
        self.stdout.write("  hassan@demo.local / Demo@12345 (Family Admin)")
        self.stdout.write("  amina@demo.local / Demo@12345 (Family Member)")
